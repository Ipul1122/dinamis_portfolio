...
<head>
    ...
    <title>Welcome di dashboard</title>
        ...
        <div class="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
            <div class="text-center ">
                <h1
                    ...
                    <span class="block xl:inline"><span class="mb-1 block">Ingin punya web?</span>
                    ...
                    <div class="mt-2">Kami
                        ...
                        <span class="relative">Berpengalaman  </span>
                        </span>
                    </div>
                </h1>
                <p class="mx-auto mt-3 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
                    Membantu anda untuk membangun sebauh web yang modern dan berkualitas. Dengan harga yang terjangkau dan berkelas
                </p>
