<footer class="bg-gray-900 text-white py-8 px-6">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
      <!-- Nama Portfolio -->
      <div class="md:col-span-1">
        <h2 class="text-2xl font-bold">Nama Portfolio</h2>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-1">
          ...
          <li><a href="#scient" class="hover:underline">Scient</a></li>
        </ul>
      </div>
    ...
    <div class="mt-8 border-t border-gray-700 pt-4 text-center text-sm text-gray-400">
      &copy; {{ date('Y') }} Nama Portfolio. All rights reserved.
    </div>
  </footer>
